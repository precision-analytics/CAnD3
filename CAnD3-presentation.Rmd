...
> -  Large push towards "automating" analytics is set to change the role of data scientists (e.g. Data Robot, Alteryx, Dataiku, Google Cloud AI); storytelling and substantive expertise are the last aspects of data and communication that cannot be productized 
