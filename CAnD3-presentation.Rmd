...
output: 
    ...
    incremental: false
    df_print: kable
footer: "Consortium on Analytics for Data-Driven Decision-Making (CAnD3), March 2021"
css: mystyle.css
autosize: true 
---
...
```{r ds_fig, out.width = "40%", fig.align='center'}
...
Data available for [2021](https://www.kaggle.com/c/kaggle-survey-2021)   

Demographics of respondents 
=====================================================

```{r demo-fig, out.width= "75%", out.height= "60%"}
...
```{r position-fig, out.width= "75%", out.height= "60%"}
...
```{r phd_fig, out.width= "75%", out.height= "60%"}
...
```{r coding-fig, out.width= "75%", out.height= "60%"}
...
```{r tool-fig, out.width= "75%", out.height= "60%"}
...
```{r mlyears_fig, out.width= "75%", out.height= "60%"}
...
knitr::include_graphics("figs/employerfears_fig.png")
...
`r emoji("check")` Be ready to start at the bottom

`r emoji("check")` Be ready be creative in your search and to be a hustler 
...
> -  Large push towards "automating" analytics is set to change the role of data scientists (e.g. Data Robot, Alteryx, Dataiku, Google Cloud AI); storytelling is one of the last aspects of data and communication that cannot be productized 
...
This presentation & R code can be found online [https://github.com/precision-analytics/CSCDS](https://github.com/precision-analytics/CSCDS).
